...
const SearchMovie = () => {
    ...
    return (
        <>
            ...
            {
                searchedMovie ? ( <MovieList title={movieName} searchMovie={true} movies={searchedMovie}/>) : (<h1 style={{marginLeft:"700px",marginTop:"100px",fontSize:"20px"}}>Movie Not Found!!</h1>)
            }
