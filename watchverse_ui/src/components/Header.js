...
const Header = () => { 
    ...
    return (
        <div className='absolute z-10 flex w-full items-center justify-between px-6 bg-gradient-to-b from-black'>
            ...
            {/* <img className='w-56' src="C:\Users\91628\Desktop\WAtch WArs.png" alt='netflix-logo' /> */}
            <h1 style={{color:"white",fontSize:"50px"}}>Watch<span style={{color:"red"}}>Verse</span></h1>
            {
                user && (
